...
const Syntax$json = const {
  ...
  '2': const [
    ...
    const {'1': 'SYNTAX_EDITIONS', '2': 2},
  ],
};

/// Descriptor for `Syntax`. Decode as a `google.protobuf.EnumDescriptorProto`.
final $typed_data.Uint8List syntaxDescriptor = $convert.base64Decode('CgZTeW50YXgSEQoNU1lOVEFYX1BST1RPMhAAEhEKDVNZTlRBWF9QUk9UTzMQARITCg9TWU5UQVhfRURJVElPTlMQAg==');
...
const Type$json = const {
  ...
  '2': const [
    ...
    const {'1': 'edition', '3': 7, '4': 1, '5': 9, '10': 'edition'},
  ],
};

/// Descriptor for `Type`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List typeDescriptor = $convert.base64Decode('');
...
const Enum$json = const {
  ...
  '2': const [
    ...
    const {'1': 'edition', '3': 6, '4': 1, '5': 9, '10': 'edition'},
  ],
};

/// Descriptor for `Enum`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List enumDescriptor = $convert.base64Decode('');
